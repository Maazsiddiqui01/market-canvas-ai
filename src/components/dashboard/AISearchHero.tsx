...
export const AISearchHero = () => {
  return (
    <section
      ...
      className="relative overflow-hidden rounded-3xl border border-border/60 glass-subtle p-6 md:p-10"
    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto text-center space-y-3">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 ring-1 ring-primary/30 text-primary text-xs font-medium tracking-wider uppercase">
      ...
      <div className="relative mt-6 md:mt-8 max-w-3xl mx-auto">
        <AISearchWidget />
      </div>

      <ul className="relative mt-6 grid grid-cols-1 md:grid-cols-3 gap-3 max-w-4xl mx-auto">
        {hints.map((hint) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-snug">{hint.text}</p>
            </li>
          );
        })}
      </ul>
